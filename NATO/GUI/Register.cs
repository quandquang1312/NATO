    ...
    public partial class Register : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tk.GT = cbGT.SelectedItem.ToString().Equals("Nữ");
                tk.IsAdmin = false;
                tk.HinhAnh = "";
                ...
                if (tk.MatKhau != rmk)
                {
                    Message.Instance.Show("Xác nhận mật khẩu không trùng nhau", false);
                } else
                {
            ...
            {
                Message.Instance.Show("Lỗi xảy ra. Hãy thử lại.", false);
            }
        }
