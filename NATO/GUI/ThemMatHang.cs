    ...
    public partial class ThemMatHang : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Message.Instance.Show(mss, kq);
                load_MatHang();
            }
            catch (Exception ex)
            {
                Message.Instance.Show("Nhập đủ và đúng định dạng cho dữ liệu", false);
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                Message.Instance.Show("Lỗi xảy ra", false);
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Message.Instance.Show("Bấm vô hàng sản phẩm cần sửa.", false);
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (kq == true)
                {
                    ...
                    Message.Instance.Show(mss, eff);
                    load_MatHang();
                }
            }
            catch (Exception ex)
            {
                Message.Instance.Show("Bấm vô mặt hàng cần xóa", false);
            }
        }
